            ...
            <div className='bg-[#2699fb] p-4'>
                <div className='py-3 items-center flex justify-between max-w-[1240px] mx-auto'>
                    ...
                    <ul className='hidden md:flex gap-7 text-white'>
                        ...
                        {user ? <li><button onClick={handlerLogOut}>SignOut</button></li>
                            :
                            <li><Link to='/courseDetails/login'>LogIn</Link></li>

                        }
                        {
                            user?.photoURL ? <img className='w-[32px] h-[32px] rounded-full' src={user.photoURL} alt="" />
                                :
